...
public class NavItemAdapter extends BaseExpandableListAdapter {
    ...
    // constructor
    public NavItemAdapter(Context context, List<String> expandableListTitle, HashMap<String, List<String>> expandableListDetail) {
    ...
    public View getChildView(int listPosition, final int expanded_ListPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.item_nav_child, null);
        }
        TextView expandedListTextView = (TextView) convertView.findViewById(R.id.txt_title);
    ...
    public View getGroupView(int listPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            LayoutInflater layoutInflater = (LayoutInflater) this.context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = layoutInflater.inflate(R.layout.item_nav_menu, null);
        }
        TextView listTitleTextView = convertView.findViewById(R.id.txt_title);
        ImageView arrowImage = convertView.findViewById(R.id.img_arrow);
        listTitleTextView.setTypeface(null, Typeface.BOLD);
        listTitleTextView.setText(listTitle);

        if (expandableDetailList.get(expandableTitleList.get(listPosition)).isEmpty()){
